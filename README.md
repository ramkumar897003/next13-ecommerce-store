...
## MAKE SURE YOU HAVE [ADMIN](https://github.com/ramkumar897003/next13-ecommerce-admin.git) SETUP FIRST!
...
```shell
git clone https://github.com/ramkumar897003/next13-ecommerce-store.git
```
